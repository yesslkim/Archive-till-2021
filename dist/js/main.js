  ...
  projectLists.forEach(function (projectList) {
    projectList.addEventListener('click', function (e) {
      ...
      if (link.tagName === 'A') {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(link.nextElementSibling, {
          duration: 2,
          x: -500,
          ease: "bounce"
        });
...
var initAni = function initAni() {
  gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(".header > .title", {
    duration: 2,
    rotationX: 360,
    delay: 1
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from('.about-section', {
    duration: 2,
    x: -500,
    ease: "expo"
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from('.gnb', {
    duration: 2,
    x: 500,
    ease: "expo"
  });
